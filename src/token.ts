 ...
 * by whoever signs in next — which on this surface means sending as another
 ...
 *
 * THIS IS THE TENANT LIST. Every sequence, audience and campaign on this surface belongs
 * to one of these and to nothing finer: the marketing API resolves the org from the
